...
Unprotect[GeneratorDescription, EpilogFunction, GeneratorHistoryLength, DeliveryFunction, GeneratorOutputType];

Options[DocumentGenerator] = sortOptions @ Join[{
...
Protect[GeneratorDescription, EpilogFunction, GeneratorHistoryLength, DeliveryFunction, GeneratorOutputType];
...
(* RemoveScheduledTask *)
iCloudRemoveDocumentGenerator[obj_CloudObject, mh_:TaskRemove, o:OptionsPattern[]] := (iCloudRemoveDocumentGenerator[safeCloudAndUUIDFetch[obj, mh], mh, o]; obj)
iCloudRemoveDocumentGenerator[{cloud_String, uuid_String}, mh_:TaskRemove, o:OptionsPattern[]] :=
    deleteOperation[cloud, uuid, "application/vnd.wolfram.bundle.document-generator"];
...
Protect[DocumentGenerator, DocumentGenerators, DocumentGeneratorInformation, DocumentGeneratorInformationData,
    GeneratedDocumentBinding, CloudObject];
