...
Unprotect[CloudLoggingData];

Options[CloudLoggingData] = sortOptions @ {"TimeSeriesBinSize" -> Automatic, MaxItems -> Automatic, CloudBase -> Automatic}
...
SetAttributes[CloudLoggingData, {Protected, ReadProtected}];
