...
$fromCharset := $fromCharset =
    Replace @ Dispatch @ Join[
        ...
        Select[
            {
            "adobestandard"|"adobestandardencoding"|"csadobestandardencoding" -> "AdobeStandard",
            "ansix341968"|"ansix341986"|"ascii"|"asci"|"cp367"|"csascii"|"ibm367"|"iso646irv"|"iso646us"|"isoir6"|"us"|"usascii" -> "ASCII",
            "cp936"|"csgbk"|"gbk"|"ms936"|"windows936" -> "CP936",
            "cseucpkdfmtjapanese"|"eucjp"|"extendedunixcodepackedformatforjapanese" -> "EUC-JP",
            "850"|"cp850"|"cspc850multilingual"|"ibm850" -> "IBM-850",
            "cp819"|"csisolatin1"|"ibm819"|"iso88591"|"isoir100"|"l1"|"latin1" -> "ISO8859-1",
            "csisolatin6"|"iso885910"|"isoir157"|"l6"|"latin6" -> "ISO8859-10",
            "csiso885915"|"iso885915"|"latin9" -> "ISO8859-15",
            "csiso885916"|"iso885916"|"isoir226"|"l10"|"latin10" -> "ISO8859-16",
            "csisolatin2"|"iso88592"|"isoir101"|"l2"|"latin2" -> "ISO8859-2",
            "csisolatin3"|"iso88593"|"isoir109"|"l3"|"latin3" -> "ISO8859-3",
            "csisolatin4"|"iso88594"|"isoir110"|"l4"|"latin4" -> "ISO8859-4",
            "csisolatincyrillic"|"cyrillic"|"iso88595"|"isoir144" -> "ISO8859-5",
            "arabic"|"asmo708"|"csisolatinarabic"|"ecma114"|"iso88596"|"isoir127" -> "ISO8859-6",
            "csisolatingreek"|"ecma118"|"elot928"|"greek"|"greek8"|"iso88597"|"isoir126" -> "ISO8859-7",
            "csisolatinhebrew"|"hebrew"|"iso88598"|"isoir138" -> "ISO8859-8",
            "csisolatin5"|"iso88599"|"isoir148"|"l5"|"latin5" -> "ISO8859-9",
            "cskoi8r"|"koi8r" -> "koi8-r",
            "macarabic"|"macintosharabic" -> "MacintoshArabic",
            "csgb18030"|"csgb2312"|"gb18030"|"gb180302000"|"gb2312"|"gbk"|"macchinesesimplified"|"macintoshchinesesimplified" -> "MacintoshChineseSimplified",
            ...
            "csshiftjis"|"mskanji"|"shiftjis"|"sjis" -> "ShiftJIS",
            "csutf8"|"utf8" -> "UTF8"
            },
